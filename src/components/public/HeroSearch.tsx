...
export function HeroSearch() {
  return (
    <form action="/aanbod" className="mt-8 grid gap-3 rounded bg-white p-3 shadow-card sm:grid-cols-[1fr_auto]">
      ...
      <button className="h-14 rounded bg-night px-6 text-sm font-extrabold text-white transition hover:bg-navy">
        Zoeken
      </button>
    </form>
  );
